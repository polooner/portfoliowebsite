...
export function ButtonInside() {
  return (
    <form className="text-sm leading-5 font-normal tracking-[-0.35px] w-3/4 mx-auto">
      <div className="text-muted-foreground flex items-center  gap-1 shadow-[0_1px_1px_rgba(0,0,0,0.03)] py-0 px-3 transition-[border-color] duration-[80ms] border-[0.5px] border-solid border-black/15 focus-within:ring-1 focus-within:ring-ring transition-all duration-300 ease-in-out">
