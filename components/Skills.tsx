...
const Skills = (props: Props) => {
  return (
    <motion.article
      className="h-screen relative text-center mx-4 items-center my-10 md:my-20 justify-center"
      initial={{
        x: -200,
        opacity: 0,
      }}
    ...
    >
      <h1 className="font-bold text-4xl py-8 md:py-16 tracking-tight bg-gradient-to-r from-black text-transparent to-yellow-300 bg-clip-text">
        Skills
      </h1>
