...
const Contact = (props: Props) => {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:wojdafilipdev@gmail?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${formData.message} ${formData.email}`;
  };
  ...
  return (
    ...
    >
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center bg-clip-text bg-gradient-to-r from-black text-transparent to-green-300">
          Contact Me
        </h2>
