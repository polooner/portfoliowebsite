...
>(({ className, thumbVariant = "default", ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-[14px] w-full grow overflow-hidden  bg-neutral-300">
      <SliderPrimitive.Range className="absolute h-full bg-neutral-900/50 " />
    ...
    <SliderPrimitive.Thumb
      className={cn(
        ...
        thumbVariant === "thin"
          ...
          : "h-4 w-4  border border-primary/50 bg-background shadow-lg"
      )}
    />
  </SliderPrimitive.Root>
))
