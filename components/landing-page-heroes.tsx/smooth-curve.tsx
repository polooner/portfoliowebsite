    ...
    >
      <div className="flex flex-col pt-[10px] items-center self-center justify-center gap-4">
        <div className="flex flex-col items-center justify-center self-center mx-auto md:w-8/12">
            ...
            >
              {sentences[currentSentenceIndex].split(' ').map((word, i) => (
                <motion.span
                  ...
                  onAnimationComplete={
                    i === sentences[currentSentenceIndex].split(' ').length - 1 && isAnimating
          ...
          <Button variant={'tiltingShadow'} size={'minimal'} className="self-start mt-4">
          ...
          <SimpleCard
            ...
            upperHalfContent={
              <p className="text-center text-md self-center items-center h-full justify-center p-2 flex">
                this will we a cool ascii image. i promise. in the meantime you have to read this
                text and bear with the not so nice looks of it.
              </p>
            }
          />
          <SimpleCard
    ...
    >
      <div className="flex flex-col pt-[10px] items-center self-center justify-center gap-4">
        <div className="flex flex-col items-center justify-center self-center mx-auto md:w-8/12">
          ...
          <AnimatePresence mode="wait">
            {/* @ts-expect-error - Framer Motion type issue with React 19 */}
            <motion.div
              key={currentSentenceIndex}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
