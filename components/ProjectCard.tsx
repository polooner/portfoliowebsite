  ...
  return (
    <article
      className="flex flex-col rounded-lg items-center flex-shrink-0 justify-evenly
        w-[300px] md:w-[400px] xl:w-[600px] h-[400px] md:h-[550px] xl:h-[600px] snap-center bg-zinc-200 opacity-60 hover:opacity-100 duration-300"
    >
      <div className="px-[5%]">
        ...
        <ul
          id="skill's list"
          className="text-start list-disc space-y-4 ml-5 text-xs md:text-md"
        >
