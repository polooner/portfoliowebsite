 ...
 * The checkmark draws itself in with a stroke animation.
 */
export function CopyButton({ getText }: CopyButtonProps) {
  ...
  return (
    <motion.button
      onClick={handleCopy}
      whileTap={{ scale: 0.95 }}
      className="flex h-8 items-center gap-2  border border-white/10 bg-neutral-700/50 px-3 text-xs text-neutral-300 transition-colors hover:bg-neutral-600/50"
    >
